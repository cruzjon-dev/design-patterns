...
/****************************************************************
 * VISITOR
 * - A behavioral design pattern that allows adding new behaviors to existing class hierarchy without altering any existing code.
 * - It uses a technique called Double Dispatch, which helps to execute the proper method on an object without cumbersome conditionals. Instead of letting the client select a proper version of the method to call, we delegate this choice to objects we’re passing to the visitor as an argument.
****************************************************************/
